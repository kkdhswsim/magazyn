    ...
    <div class="container" style="width: 770px; background-color:white ;">
        ...
        <div id="main"> 
            <div class="content">
                ...
                <!--//////////////////// Główna część strony///////////////////////// -->
                <a href="<%= request.getContextPath()%>/ciezarowka?op=create" class="btn btn-mini btn-primary">Dodaj ciężarówkę</a>
                <table class="table table-striped">
                    ...
                    <%
                      for(int i=0; i<list.size(); i++){
                          ...
                          kierow = (ciezarowka)list.get(i);
                    %>
                <tr>
                    <td><%= kierow.getId() %></td>
                    <td><%= kierow.getMarka() %></td>
                    <td><%= kierow.getModel() %></td>
                    <td><%= kierow.getRejestracja() %></td>
                    <td><a href="ciezarowka?op=update&poz=<%= i%>&id=<%= kierow.getId() %>" class="btn btn-mini btn-primary">Edytuj</a>
                        <a href="ciezarowka?op=delete&poz=<%= i%>&id=<%= kierow.getId() %>" class="btn btn-mini btn-primary">Usun</a>
                    </td>
                </tr>
                 <%
                  }
