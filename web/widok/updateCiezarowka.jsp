            ...
            <div class="content">
                ...
                %>
                    ...
                    <form id="formDostawcy" name="formDostawcy" action="<%= request.getContextPath()%>/ciezarowka" method="post">
                        <h4>Edytuj ciężarówkę nr: <%= kierow.getId() %></h4>
                        <input type="hidden" class="form-control" name="info" value= '0'>
                        <input type="hidden" class="form-control" name="id" value= '<%= kierow.getId() %>'>
                        <input type="text" class="form-control" placeholder="Imie" name="marka_ciezarowki" aria-describedby="basic-addon1" value="<%= kierow.getMarka() %>"><br/><br/>
                        <input type="text" class="form-control" placeholder="Nazwisko" name="model_ciezarowki" aria-describedby="basic-addon1" value="<%= kierow.getModel() %>"><br/><br/>
                        <input type="text" class="form-control" placeholder="Nr dokumentu" name="rejestracja_ciezarowki" aria-describedby="basic-addon1" value="<%= kierow.getRejestracja() %>"><br/><br/>
                    <button type="submit" class="btn btn-default navbar-btn">Edytuj ciężarówkę</button>
