...
<html>
    ...
    <form id="formDostawcy" name="formDostawcy" action="<%= request.getContextPath()%>/dostawcy" method="post">
        <h4>Dodaj dostawcę</h4>
        <input type="hidden" id="id" name="id" value=" ">
        <input type="text" class="form-control" placeholder="Nazwa firmy" name="nazwa_firmy" aria-describedby="basic-addon1" value=""><br/><br/>
