    ...
    <div class="container" style="width: 770px; background-color:white ;">
        ...
        <div id="main"> 
            <div class="content">
                ...
                <!--//////////////////// Główna część strony///////////////////////// -->
                <a href="<%= request.getContextPath()%>/kierowcy?op=create" class="btn btn-mini btn-primary">Dodaj kierowcę</a>
                ...
                <tr>
                    ...
                    <td><a href="kierowcy?op=update&poz=<%= i%>&id=<%= kierow.getId() %>" class="btn btn-mini btn-primary">Edytuj</a>
                        <a href="kierowcy?op=delete&poz=<%= i%>&id=<%= kierow.getId() %>" class="btn btn-mini btn-primary">Usun</a>
                    </td>
                </tr>
                 <%
                  }
