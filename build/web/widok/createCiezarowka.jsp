        ...
        <div id="main"> 
            <div class="content">
                ...
                <form id="formDostawcy" name="formDostawcy" action="<%= request.getContextPath()%>/ciezarowka" method="post">
                    <h4>Dodaj ciężarowkę</h4>
                    <input type="hidden" class="form-control" name="info" value= '0'>
                    <input type="hidden" id="id" name="id" value="0">
                    <input type="text" class="form-control" placeholder="Marka" name="marka_ciezarowki" aria-describedby="basic-addon1" value=""><br/><br/>
                <input type="text" class="form-control" placeholder="Model" name="model_ciezarowki" aria-describedby="basic-addon1"><br/><br/>
                <input type="text" class="form-control" placeholder="Rejestracja" name="rejestracja_ciezarowki" aria-describedby="basic-addon1"><br/><br/>
                <button type="submit" class="btn btn-default navbar-btn">Dodaj ciężarówkę</button>
